    ...
    <div className="h-screen flex flex-col  justify-center items-center bg-black py-12">
      <div className="bg-white p-8 text-black rounded-lg shadow-lg mt-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full py-3 bg-orange-400 text-white cursor-pointer font-semibold rounded-md hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
          >
            Registrarse
          </button>
        </form>
